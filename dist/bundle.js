...
eval("exports = module.exports = __webpack_require__(/*! ../../../node_modules/css-loader/lib/css-base.js */ \"./node_modules/css-loader/lib/css-base.js\")(false);\n// imports\n\n\n// module\nexports.push([module.i, \".header{background-color:#f5f5f5;text-align:right;padding:0 60px}.header .header-links{margin:0;list-style:none;padding:0}.header .header-links .header-link{display:inline-block;padding:8px;-webkit-transition:all .3s linear;transition:all .3s linear;border-bottom:1px solid transparent}.header .header-links .header-link.selected,.header .header-links .header-link:hover{border-bottom:1px solid #006eff}.header .header-links .header-link .header-link-text{text-decoration:none;font-size:16px;-webkit-transition:all .3s linear;transition:all .3s linear}.header .header-links .header-link .header-link-text:hover,.header .header-links .header-link.selected .header-link-text{color:#006eff}.header .header-links .header-link.selected .header-link-text{font-weight:700}\", \"\"]);\n\n// exports\n\n\n//# sourceURL=webpack:///./src/components/header/index.css?./node_modules/css-loader??ref--5-1!./node_modules/postcss-loader/lib");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _hyperapp = __webpack_require__(/*! hyperapp */ \"./node_modules/hyperapp/src/index.js\");\n\nvar _router = __webpack_require__(/*! @hyperapp/router */ \"./node_modules/@hyperapp/router/src/index.js\");\n\nvar _index = __webpack_require__(/*! ./index.css */ \"./src/components/header/index.css\");\n\nvar _index2 = _interopRequireDefault(_index);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nexports.default = function (_) {\n  return {\n    state: {\n      headerLinks: [{\n        text: 'Counter',\n        to: '/',\n        selected: true\n      }, {\n        text: 'Todo',\n        to: '/todos',\n        selected: false\n      }]\n    },\n    actions: {\n      selectTab: function selectTab(event) {\n        return function (state) {\n          var linkToSelect = event.currentTarget.dataset.linkText;\n          state.headerLinks.forEach(function (link) {\n            if (link.text === linkToSelect) {\n              link.selected = true;\n            } else {\n              link.selected = false;\n            }\n          });\n          return state;\n        };\n      }\n    },\n    view: function view(state, actions) {\n      return (0, _hyperapp.h)(\n        \"div\",\n        { \"class\": \"header\" },\n        (0, _hyperapp.h)(\n          \"ul\",\n          { \"class\": \"header-links\" },\n          state.headerLinks.map(function (link) {\n            return (0, _hyperapp.h)(\n              \"li\",\n              { \"class\": link.selected ? \"header-link selected\" : \"header-link\", \"data-link-text\": link.text, onclick: function onclick(e) {\n                  return actions.selectTab(e);\n                } },\n              (0, _hyperapp.h)(\n                _router.Link,\n                { to: link.to, \"class\": \"header-link-text\" },\n                link.text\n              )\n            );\n          })\n        )\n      );\n    }\n  };\n};\n\n/* styles */\n\n//# sourceURL=webpack:///./src/components/header/index.js?");
